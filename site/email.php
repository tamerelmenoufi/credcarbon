...
$dados = [
    ...
    'subject' => 'Envio html API\'Mailgun Do CredCabon',
    'html' => '<html><h2>Título da html de teste</h2><p>Descrição da html de teste da API</p><a href="http://os.bkmanaus.com.br" target="_blank"><img src="cid:img_bk.png" /></a></html>',
    'attachment' => [
            './img_bk.png',
